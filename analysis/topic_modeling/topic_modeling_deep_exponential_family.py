...
# UTILS
def save_to_csv(data, csvfilename):
  df = pd.DataFrame(data)
  df.to_csv(csvfilename)
  print("Wrote: " + csvfilename)
  return csvfilename
...
for epoch in range(n_epoch):
  ...
  save_to_csv(sess.run(qW0), "topics_and_words_" + timestamp + ".csv")
  save_to_csv(sess.run(qz3), "docs_and_topics_" + timestamp + ".csv")